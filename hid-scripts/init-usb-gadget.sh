...
# Originally from: https://github.com/tiny-pilot/ansible-role-tinypilot/blob/master/files/init-usb-gadget
# Minor modifications to customize src location for helpers, names, etc
...
echo "ghaven" > "${USB_STRINGS_DIR}/manufacturer"
